...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div className="shadow-2xl">
      ...
      <div className={`${newSidebar ? 'left-0' : '-translate-x-full'} fixed h-screen transition-all duration-300 ease-in-out top-24  z-40 rounded-lg shadow-lg bg-white w-[110px] md:w-[130px] border-l-[1px]`}>
        {
