...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div className="shadow-2xl bg-white">
      <div
        className={`fixed z-50 top-24 pb-24 left-0 h-screen  text-sm transition-transform duration-300 ease-in-out  custom-scrollbar rounded-lg
      ...
      <div className={`${newSidebar ? 'translate-x-full' : ''} fixed h-screen transition-all duration-300 ease-in-out top-24 left-0 z-40 rounded-lg shadow-lg  w-[110px] md:w-[130px] border-l-[1px]`}>
        {
