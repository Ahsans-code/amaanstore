...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div className={`shadow-2xl z-50  ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
      ...
      <div className={`${newSidebar ? 'left-[110px]' : '-translate-x-full'} fixed h-screen transition-all duration-300 ease-in-out top-24   rounded-lg shadow-lg bg-white w-[150px] md:w-[220px] border-l-[1px]`}>
        {
