...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div className={`w-fit shadow-2xl z-50 `}>
      ...
      <div className={`${newSidebar ? 'left-[110px]' : '-translate-x-full'} fixed h-screen transition-all duration-300 ease-in-out top-24 shadow-3xl  z-40 rounded-lg  bg-white w-[150px] md:w-[220px] border-l-[1px]`}>
        {
