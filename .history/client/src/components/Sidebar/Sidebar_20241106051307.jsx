...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div className={`w-fit shadow-2xl z-50`}>
      <div
        className={`fixed shadow-2xl z-50 top-24 pb-24 left-0 h-screen bg-white text-sm transition-transform duration-300 ease-in-out  custom-scrollbar rounded-lg
      ...
      <div className={`${newSidebar ? 'left-[110px]' : '-translate-x-full'} fixed h-screen transition-all duration-300 ease-in-out top-24  z-40 rounded-lg shadow-lg bg-white w-[150px] md:w-[220px] border-l-[1px]`}>
        {
