...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div className={`w-fit  z-50 `}>
      <div
        className={`fixed  z-50 top-24 pb-24 left-0 h-screen bg-white text-gray-400 text-sm transition-transform duration-300 ease-in-out  custom-scrollbar rounded-lg
