...
const [neSidebar,setNewSidebar]=useState(false)
    ...
    return (
        <div
            className={`fixed flex top-24 pb-24 left-0 h-screen bg-white text-sm transition-transform duration-300 ease-in-out shadow-2xl custom-scrollbar
        ...
        >
            ...
            <div className="h-screen top-24 rounded-2xl shadow-lg bg-white w-28">
