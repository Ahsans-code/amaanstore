...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div className="shadow-2xl">
      ...
      <div className={`${newSidebar ? 'translate-x-full' : ''} fixed h-screen transition-all duration-300 ease-in-out top-24 left-0 z-40 rounded-lg shadow-lg bg-white w-[110px] md:w-[530px] border-l-[1px]`}>
        {
