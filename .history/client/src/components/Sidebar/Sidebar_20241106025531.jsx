...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div className="shadow-2xl">
      ...
      <div className={`${newSidebar?'translate-x-full':''} fixed h-screen transition-all duration-300 ease-in-out top-0 z-40 rounded-2xl shadow-lg bg-white w-[100px] md:w-[110px] border-l-[1px]`}>
