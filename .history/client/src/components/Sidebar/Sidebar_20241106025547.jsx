...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div className="shadow-2xl">
      <div
        className={`fixed z-50 top-24 pb-24 left-0 h-screen bg-white text-sm transition-transform duration-300 ease-in-out  custom-scrollbar
      ...
      <div className={`${newSidebar?'translate-x-full':''} fixed h-screen transition-all duration-300 ease-in-out top-24 z-40 rounded-2xl shadow-lg bg-white w-[100px] md:w-[110px] border-l-[1px]`}>
