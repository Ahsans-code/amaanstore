...
const Sidebar = ({ sidebarOpen }) => {
  ...
  const [multipleTabs, setMultipleTabs] = useState([])
  const menuItems = [
    ...
    { icon: RiShoppingCart2Line, label: "Orders", options: [] },
    { icon: RiShoppingCart2Line, label: "Products", options: [] },
