			...
			{showSearchInput ? 
				...
				: (
					<>
						...
						<Link
							to={"/"}
							className=' flex flex-col items-center justify-center  font-semibold text-lg md:text-xl lg:text-2xl max-sm:text-lg text-primary text-center xl:-translate-x-1/2'
						>
