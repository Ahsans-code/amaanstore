			...
			{showSearchInput ? 
				...
				: (
					<>
						...
						<Link
							to={"/"}
							className=' flex flex-col items-center justify-center  font-semibold text-lg md:text-xl lg:text-2xl max-md:hidden text-primary text-center xl:-translate-x-1/2'
						>
							<img className=" w-20 backdrop-brightness-0" src={logo} alt="" />
						</Link>
