			...
			{showSearchInput ? 
				...
				: (
					<>
						...
						<Link
							to={"/"}
							className='flex items-center max-sm:hidden font-semibold text-lg md:text-xl lg:text-2xl text-gray-600 text-center xl:-translate-x-1/2'
						>
							<PiLastfmLogoBold  className="text-primary"/>Amaan Store
						</Link>
