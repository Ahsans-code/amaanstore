			...
			{showSearchInput ? 
				...
				: (
					<>
						...
						<Link
							to={"/"}
							className=' flex flex-col items-center justify-center  font-semibold text-lg md:text-xl lg:text-2xl text-primary text-center xl:-translate-x-1/2'
						>
							<PiLastfmLogoBold  size={30}/><span className="font-bold max-sm:hidden text-gray-400 logo ">Amaan Store</span> 
						</Link>
