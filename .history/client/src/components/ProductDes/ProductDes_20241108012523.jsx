...
export default function ProductDes({ customerName, imageUrl, description, price, quantity, totalPrice, onClick }) {
    return (
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3 mt-12 sm:mt-16 md:mt-20 lg:mt-24 max-h-[80vh] custom-scrollbar">
