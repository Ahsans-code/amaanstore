...
export default function ProductDes({customerName,imageUrl,description,price,quantity,totalPrice}) {
  return (
    ...
    <h2 className="text-lg font-bold mb-4 flex items-center justify-between">{customerName}'s Order Details
        <MdCancel className=" text-red-500" size={25}  onClick={() => setModalData(null)} />
    </h2>
