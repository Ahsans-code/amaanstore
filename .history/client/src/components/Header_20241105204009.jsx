...
const Header = ({ toggleSidebar }) => {
	...
	return (
		<div className='h-24 fixed z-[50] w-full bg-white text-gray-600  md:p-6 lg:p-8 shadow-sm border-b flex items-center justify-between'>
			...
			{showSearchInput ? ''
				...
				: (
					<>
						<div className='flex gap-3 md:gap-3 lg:gap-4 items-center'>
							...
							<div className="relative inline-block w-fit">
								<button
									...
									className="appearance-none bg-gray-100 rounded-full py-[8px] px-3 text-xs md:text-sm text-gray-500 w-full flex justify-between items-center"
								>
						...
						<Link
							to={"/"}
							className='font-semibold text-lg md:text-xl lg:text-2xl text-gray-600 text-center -translate-x-1/2'
						>
							Amaan Store
						</Link>
						<ul className='flex gap-3 md:gap-4 items-center justify-self-end'>
							<Button text={"Track Orders"}/>
