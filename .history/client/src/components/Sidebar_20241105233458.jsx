...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <div
      className={`fixed top-0 md:top-24 pb-24 left-0 h-full md:h-screen bg-white text-sm transition-transform duration-300 ease-in-out shadow-2xl custom-scrollbar
