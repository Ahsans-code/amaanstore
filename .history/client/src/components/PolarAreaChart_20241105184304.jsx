...
function PolarAreaChart() {
    ...
    return (
        <div className="bg-white rounded-2xl px-7 py-2 h-96 w-full shadow-lg relative">
            <h2 className='py-4 text-lg'>Products Categories</h2>
         
            <PolarArea className='p-10  absolute inset-0 border-2 w-full ' data={data} options={options} />
