...
const Header = ({ toggleSidebar }) => {
	...
	return (
		<div className='h-24 fixed z-[50] w-full bg-white  md:p-6 lg:p-8 shadow-sm border-b flex items-center '>
			...
			{showSearchInput ? ''
				...
				: (
					<>
						...
						<Link
							to={"/"}
							className='font-semibold text-lg md:text-xl lg:text-2xl text-gray-600 justify-self-center'
						>
							Amaan Store
						</Link>
