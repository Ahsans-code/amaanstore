...
const Sidebar = ({ sidebarOpen }) => {
	...
	return (
		<div
			className={`fixed top-22 py-2 left-0 h-screen text-sm w-32 rounded-lg
				${sidebarOpen ? "translate-x-0" : "-translate-x-full"}
				transition-transform duration-300 ease-in-out z-50 shadow-xl overflow-auto custom-scrollbar`}
						...
						return (
							<li
								...
								className={`menuItem flex-col py-6 flex items-center cursor-pointer border-b border-gray-300 relative last:border-0
									${
										isActive
											? "text-[#4B9E60] before:content-[''] before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1 before:bg-[#4B9E60] before:rounded-full"
											: "text-[#404040]"
									}
								`}
