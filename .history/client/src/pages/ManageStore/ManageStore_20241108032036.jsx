                    ...
                    {storeData.map((store, i) => (
                        <div key={i} className="w-full max-w-lg mx-auto p-8 bg-green-100 rounded-2xl shadow-lg text-center relative">
                            ...
                            <Link
                                to={'Products'}
                                type="submit"
                                className="flex mt-3 justify-center w-full px-6 py-2 bg-blue-400 text-white font-semibold rounded-lg shadow-md hover:bg-blue-500 transition-all duration-300"
                            >
                                Edit Store
                            </Link>
