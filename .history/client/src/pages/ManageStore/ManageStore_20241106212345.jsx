            ...
            {storeData.length > 0 ?
                <div className="w-full grid grid-cols-2 gap-10">
                    ...
                    {storeData.map((store, i) => (
                        <div key={i} className="w-full max-w-lg mx-auto p-8 bg-secondary rounded-2xl shadow-lg text-center relative">
                            ...
                            <button
                                type="submit"
                                className="w-full px-6 py-2 bg-primary text-white font-semibold rounded-lg shadow-md hover:bg-green-600 transition-all duration-300"
                            >
                                Manage Store
                            </button>
                        </div>
                ...
                (
                    <div className="w-full flex h-full flex-col items-center justify-center ">
                        ...
                        <Link
                            to={'/Create-Store'}
                            type="submit"
                            className="w-full md:w-[170px] lg:w-[220px] px-6 py-2 bg-primary text-white font-semibold rounded-lg shadow-md text-center hover:bg-green-600 transition-all duration-300"
                        >
                            Create Store
                        </Link>
                    </div>
