                ...
                (
                    <div className="w-full flex h-full flex-col items-center justify-center ">
                        ...
                        <Link
                            to={'/Create-Store'}
                            type="submit"
                            className="w-full md:w-[170px] lg:w-[220px] px-6 py-2 bg-green-700 text-white font-semibold rounded-lg shadow-md text-center hover:bg-green-600 transition-all duration-300"
                        >
                            Create Store
                        </Link>
                    </div>
