			...
			<div className="flex flex-col lg:flex-row items-start py-6 lg:h-[110vh] ">
				<div className="w-full lg:w-1/2 h-full max-lg:pb-4 lg:pr-3">
					<div className="  w-full h-1/3 ">
						<Slider className="home-options h-full" {...settings}>
							{iconcard.map((item, index) => (
								<div className="h-full">
									<div key={index} className="h-full max-lg:py-4 flex flex-col items-center justify-center bg-white rounded-2xl shadow-md text-center">
										<p className="text-4xl text-[#4B9E60] w-full text-center">{item.icon}</p>
