  ...
  return (
    <div className='w-full  px-4 md:px-8 lg:px-12 py-10 '>
      ...
      <div className='bg-white p-8 rounded-xl w-3/4 mt-9'>
        ...
        <div className='mt-6'>
          <div className='flex justify-between text-xs font-semibold uppercase text-center'>
            <p>Item</p>
            <p>Count</p>
            <p>price</p>
          </div>
{
  invoiceData.map((item,i)=>(
    <div key={i} className='flex justify-between text-xs font-semibold uppercase text-center'>
            <p>{item.name}</p>
            <p>{item.count}</p>
            <p>{item.price}</p>
          </div>
