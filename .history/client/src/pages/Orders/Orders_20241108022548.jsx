                            ...
                            <HeaderRow>
                                ...
                                <div className=" max-md:hidden ">
                                    <HeaderCell className=" ">
                                        <div className="border-b border-gray-300 bg-bgsecondary px-2 py-3 md:px-4 md:py-5 text-center">Date</div>
                                    </HeaderCell>
                                </div>
                                <div className=" max-md:hidden ">
                                    <HeaderCell className="border-b border-gray-300 ">
                        ...
                        <Body>
                            {tableList.map((item) => (
                                <Row item={item} key={item.id} className="border-b border-gray-300">
                                    ...
                                    <div className="max-md:hidden ">
                                        <Cell >
                                            <div className="px-2 py-3 md:px-4 md:py-4 text-center max-md:hidden   ">{item.date.toLocaleDateString()}</div>
                                        </Cell>
                                    </div>
                                    <div className="max-md:hidden ">
                                        <Cell >
