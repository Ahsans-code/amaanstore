        ...
        <div className="w-full px-4 md:px-8 lg:px-12 py-10 bg-gray-100">
                    ...
                    <>
                        <Header>
                            <HeaderRow>
                                ...
                                <HeaderCell className="border-b border-gray-300 max-md:hidden ">
                                ...
                                <HeaderCell className="border-b border-gray-300 ">
                                    <div  className=" max-md:hidden bg-bgsecondary px-2 py-3 md:px-4 md:py-5 text-center">Total Price</div>
                                </HeaderCell>
                                <HeaderCell className="border-b border-gray-300">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mt-4 px-4 py-4 bg-white rounded-md shadow-md space-y-2 sm:space-y-0">
                <div className="flex items-center space-x-2">
                    ...
                    {sizes.map((size) => (
                        <button
                            ...
                            className={`px-3 py-1 rounded-md ${
                                pagination.state.size === size ? "bg-primary text-white font-bold" : "bg-gray-200 text-gray-800"
                            }`}
                    ...
                    <button
                        className={`px-3 py-1 rounded-md ${
                            pagination.state.size === dummyData.length ? "bg-primary text-white font-bold" : "bg-gray-200 text-gray-800"
                        }`}
                    ...
                    {Array(totalPages)
                        ...
                        .map((_, index) => (
                            <button
                                key={index}
                                className={`px-3 py-1 rounded-md ${
                                    pagination.state.page === index ? "bg-primary text-white font-bold" : "bg-gray-200 text-gray-800"
                                }`}
