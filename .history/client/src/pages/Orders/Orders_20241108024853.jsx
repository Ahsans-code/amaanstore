...
import { Heading, UseWindowSize } from "../../components/Components";
                    ...
                    <>
                        <Header>
                            <HeaderRow>
                                ...
                                {isMobile && <HeaderCell className="border-b border-gray-300 hidden md:table-cell">
                        ...
                        <Body>
                            {tableList.map((item) => (
                                <Row item={item} key={item.id} className="border-b border-gray-300">
                                    ...
                                    {isMobile && <Cell className="hidden md:table-cell">
