...
const Home = () => {
	...
	return (
		<div className="w-full   px-12 py-10 bg-gray-100  text-gray-700">
			...
			<div className="flex items-start py-6 h-screen ">
				<div className="w-1/2 h-full">
					<div className="flex items-center gap-4 w-full h-1/3 pb-4">
						{
							iconcard.map((item) => (
								<div className="w-1/3 pr-2 h-full">
