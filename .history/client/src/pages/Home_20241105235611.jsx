...
const Home = () => {
	...
	return (
		<div className="w-full  px-8 lg:px-12 py-10 bg-gray-100  text-gray-700">
					...
					<div className="flex items-center justify-between  w-full h-1/3 ">
						{
							iconcard.map((item) => (
								<div className="w-[31%]  h-full">
									<div className="h-full max-lg:py-4 flex flex-col items-center justify-center bg-white rounded-2xl shadow-md ">
