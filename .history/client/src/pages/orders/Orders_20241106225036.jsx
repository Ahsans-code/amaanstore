        ...
        <div className="flex space-x-2">
          ...
          {sizes.map((size) => (
            <button
              key={size}
              type="button"
              className={`px-3 py-1 rounded-md ${pagination.state.size === size ? "bg-bgsecondary text-white font-bold" : "bg-gray-200 text-gray-800"}`}
          ...
          <button
            type="button"
            className={`px-3 py-1 rounded-md ${pagination.state.size === dummyData.length ? "bg-bgsecondary text-white font-bold" : "bg-gray-200 text-gray-800"}`}
          ...
          {Array(totalPages)
            ...
            .map((_, index) => (
              <button
                key={index}
                type="button"
                className={`px-3 py-1 rounded-md ${pagination.state.page === index ? "bg-blue-500 text-white font-bold" : "bg-gray-200 text-gray-800"}`}
