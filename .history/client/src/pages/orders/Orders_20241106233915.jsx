        ...
        <div className="w-full px-4 md:px-8 lg:px-12 py-10 bg-gray-100">
            ...
            <Table data={{ nodes: tableList }} pagination={pagination} className="rounded-md shadow-md mt-10 w-full">
                {(tableList) => (
                    <>
                        <Header>
                            <HeaderRow className="bg-bgsecondary">
                                <HeaderCell className="border-b border-gray-300"><div className="px-4 py-5">ID</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300"><div className="px-4 py-5">Date</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300"><div className="px-4 py-5">Category</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300"><div className="px-4 py-5">Status</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300"><div className="px-4 py-5">Quantity</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300"><div className="px-4 py-5">Total Price</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300"><div className="px-4 py-5">Details</div></HeaderCell>
                            </HeaderRow>
                        </Header>
