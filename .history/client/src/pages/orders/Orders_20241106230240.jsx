                    ...
                    <>
                        <Header>
                            <HeaderRow className="bg-gray-200">
                                <HeaderCell className="p-4 border-b border-gray-300"><div className="py-8">Task</div></HeaderCell>
                                <HeaderCell className="p-4 border-b border-gray-300"><div className="py-8">Deadline</div></HeaderCell>
                                <HeaderCell className="p-4 border-b border-gray-300"><div className="py-8">Type</div></HeaderCell>
                                <HeaderCell className="p-4 border-b border-gray-300"><div className="py-8">Complete</div></HeaderCell>
                                <HeaderCell className="p-4 border-b border-gray-300"><div className="py-8">Tasks</div></HeaderCell>
                            </HeaderRow>
                        </Header>
                        ...
                        <Body>
                            {tableList.map((item) => (
                                <Row item={item} key={item.id} className="border-b border-gray-300">
                                    <Cell>
                                        <div className="px-4 py-4">{item.name}</div>
                                    </Cell>
                                    <Cell>
                                    ...
                                    <Cell>
                                        <div className="px-4 py-4">{item.type}</div>
                                    </Cell>
                                    <Cell>
                                        <div className="px-4 py-4">{item.isComplete.toString()}</div>
                                    </Cell>
                                    <Cell>
                                        <div className="px-4 py-4">{item.nodes?.length}</div>
                                    </Cell>
                                </Row>
                            ))}
                        </Body>
