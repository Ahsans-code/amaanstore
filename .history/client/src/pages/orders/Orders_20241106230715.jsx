...
const Orders = () => {
    ...
    return (
        <div className="w-full px-8 py-4 bg-gray-100">
            <Table data={{ nodes: tableList }} pagination={pagination} className={'rounded-md shadow-md'}>
                {(tableList) => (
                    <>
                        <Header>
                            <HeaderRow className="bg-gray-200">
                                <HeaderCell className=" border-b border-gray-300"><div className=" px-4 py-5 bg-primary">Task</div></HeaderCell>
                                <HeaderCell className=" border-b border-gray-300"><div className=" px-4 py-5 bg-primary">Deadline</div></HeaderCell>
                                <HeaderCell className=" border-b border-gray-300"><div className=" px-4 py-5 bg-primary">Type</div></HeaderCell>
                                <HeaderCell className=" border-b border-gray-300"><div className="py-5 bg-primary">Complete</div></HeaderCell>
                                <HeaderCell className=" border-b border-gray-300"><div className="py-5 bg-primary">Tasks</div></HeaderCell>
                            </HeaderRow>
                        </Header>
