      ...
      <Table data={{ nodes: tableList }} pagination={pagination}>
        {(tableList) => (
          <>
            ...
            <Body>
              {tableList.map((item) => (
                <Row item={item} key={item.id} className="py-8">
                  <Cell className="p-4 py-8 border-b border-gray-300">{item.name}</Cell>
                  <Cell className="p-4 py-8 border-b border-gray-300">
                  ...
                  <Cell className="p-4 py-8 border-b border-gray-300">{item.type}</Cell>
                  <Cell className="p-4 py-8 border-b border-gray-300">{item.isComplete.toString()}</Cell>
                  <Cell className="p-4 py-8 border-b border-gray-300">{item.nodes?.length}</Cell>
                </Row>
              ))}
            </Body>
          </>
