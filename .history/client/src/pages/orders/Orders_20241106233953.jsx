            ...
            <Table data={{ nodes: tableList }} pagination={pagination} className="rounded-md shadow-md mt-10 w-full">
                {(tableList) => (
                    <>
                        <Header>
                            <HeaderRow className="">
                                <HeaderCell className="border-b border-gray-300 bg-bgsecondary"><div className="px-4 py-5">ID</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300 bg-bgsecondary"><div className="px-4 py-5">Date</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300 bg-bgsecondary"><div className="px-4 py-5">Category</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300 bg-bgsecondary"><div className="px-4 py-5">Status</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300 bg-bgsecondary"><div className="px-4 py-5">Quantity</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300 bg-bgsecondary"><div className="px-4 py-5">Total Price</div></HeaderCell>
                                <HeaderCell className="border-b border-gray-300 bg-bgsecondary"><div className="px-4 py-5">Details</div></HeaderCell>
                            </HeaderRow>
                        </Header>
