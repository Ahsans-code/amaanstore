...
import { ImageCards, ProductForm } from "../../components/Components";
...
const ProductsList = () => {
    ...
    const items = [
        {
            title: "Item 1",
            description:
                "This is a description for item 1.This is a description for item 1.This is a description for item 1.This is a description for item 1.",
            price: "$5",
    ...
    return (
        <div className='bg-gray-100 shadow-inner min-h-screen p-4 lg:p-12'>
            ...
            <div
                className={`mt-2 flex-col gap-2 ${displayOptionsVisible ? "flex" : "hidden"
            ...
            {
                isModalVisible &&
                <div className="fixed pt-24 inset-0 bg-bgsecondary flex justify-center items-center">
                  
                    <ProductForm onClick={()=>setIsModalVisible(false)} />
                </div>
            }
